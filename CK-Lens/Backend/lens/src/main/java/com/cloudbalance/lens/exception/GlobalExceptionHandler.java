...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBadAPIRequestEx(MissingServletRequestParameterException ex, HttpServletRequest request) {
        log.warn("Bad API request: {}", ex.getMessage());
        return buildResponse(HttpStatus.BAD_REQUEST, ex.getMessage(), request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleInvalidArguments(CustomException.InvalidArgumentsException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleRuntimeException(GenericApplicationException ex,HttpServletRequest request) {
